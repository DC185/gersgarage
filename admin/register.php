...
$name = $address= $county = $city = $mobile = $email = $password = $confirm_password = "";
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($email_err) && empty($password_err) && empty($confirm_password_err)){
        ...
        $sql = "INSERT INTO customer (name, address, county, city, mobile, email, password) VALUES (?, ?, ?, ?, ?, ?, ?)";
         
        if($stmt = $mysqli->prepare($sql)){
            // Bind variables to the prepared statement as parameters
            $stmt->bind_param("sssssss", $param_name, $param_address, $param_county, $param_city, $param_mobile, $param_email, $param_password);
