...
if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true){
    ...
    if(isset($_POST['submit']))
    {
        ...
        $sql=mysqli_query($mysqli,"INSERT into customer_vehicle(id_customer,make_model,reg,type,engine_type) value('$uid','$make_model','$reg','$type','$engineType')");
        if ($sql) {
                                        ...
                                        <div class="col-12">
                                            <div class="p-20">
                                                <p style="font-size:16px; color:red" align="center"> <?php if($msg){echo $msg;}  ?> </p>
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-2 col-form-label" for="example-email">Vehicle Type</label>
                                                        <div class="col-10">
                                                            <select class="form-control" id="type" name="type" placeholder="Vehicle Type" required="true">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-10">
                                                        <select name="make_model" id="id_vehicle" class="form-control" required="true">
                                                                <option value="">Make/Model</option>
                                                                    ...
                                                                    $query=mysqli_query($mysqli,"SELECT * from vehicle");
                                                                        while($row=mysqli_fetch_array($query))
                                                                            {
                                                                             ?>    
                                                                                <option value="<?php echo $row['make_model'];?>"><?php echo $row['make_model'];?></option>
                                                                            <?php } ?>  
                                                          </select>
                                                        </div>
                                                    </div>  
