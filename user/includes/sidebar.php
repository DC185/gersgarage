            ...
            <div class="left side-menu">
                ...
                <div class="slimscroll-menu" id="remove-scroll">
                    ...
                    <div class="topbar-left">
                            ...
                            <a href="#body"><img src="assets/img/logo.svg" alt="" title="" /></a>
                    ...
                    <div class="user-box">
                        <div class="user-img">
                            <img src="assets/img/user.png" alt="user-img" title="Mat Helme" class="rounded-circle img-fluid">
                        </div>

                         <?php
$uid=$_SESSION['sid'];
$ret=mysqli_query($mysqli,"SELECT name from customer where id_customer='$uid'");
